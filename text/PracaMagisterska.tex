...
\section{ Zastosowanie modelowania fonemów z ograniczonym kontekstem w ASR }	
	...
	\subsection{ Definicja modelu z ograniczonym kontekstem }
		...
		\begin{itemize}
			...
			\item $(k-l+m)$ 
			\item $(x-y+z) \equiv (w-y+z) \equiv (u-y+t)$
		\end{itemize} 
