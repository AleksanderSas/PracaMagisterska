...
\section {Rozpoznawanie mowy z zastosowaniem ukrytych modeli markowa}
    ...
    W najprostszej implementacji dla każdego słowa ze słownika, można stworzyć osobny ciąg stanów.
    
    \begin{figure}[H]
    	\centering
    	\begin{tabular}{|c|}
    		\hline
    		\textit{kot} = [k o t],  \textit{kos} = [k o s],  \textit{kasa} = [k a s a]\\ 
    		\hline \\
    		...
    		\begin{scope} 		
   			...
   			\node [hmm] (hmm1) {$k$};
   			\node [hmm, right of=hmm1] (hmm2) {$o$};
   			\node [hmm, right of=hmm2] (hmm3) {$t$};
   			
   			\node [hmm, below of=hmm1] (hmm4) {$k$};
   			\node [hmm, right of=hmm4] (hmm5) {$o$};
   			\node [hmm, right of=hmm5] (hmm6) {$s$};
   			
   			\node [hmm, below of=hmm4] (hmm7) {$k$};
   			\node [hmm, right of=hmm7] (hmm8) {$a$};
   			\node [hmm, right of=hmm8] (hmm9) {$s$};
   			\node [hmm, right of=hmm9] (hmm10) {$a$};
   			
   			\node [hmm, left = 2 cm of hmm4] (start) {$start$};
   			\node [hmm, right = 4 cm of hmm6] (stop) {$stop$};
   			
   			\coordinate [below of=hmm10] (P1);
   			\coordinate [below of=hmm7] (P2);
   			...
   			\draw[thick,->,shorten >=1pt] (hmm7) to [out=0,in=180] (hmm8);
   			\draw[thick,->,shorten >=1pt] (hmm8) to [out=0,in=180] (hmm9);
 			\draw[thick,->,shorten >=1pt] (hmm9) to [out=0,in=180] (hmm10);
   			...
   			\draw[thick,->,shorten >=1pt] (start) to [out=15,in=180] (hmm1);
   			\draw[thick,->,shorten >=1pt] (start) to [out=0,in=180] (hmm4);
   			\draw[thick,->,shorten >=1pt] (start) to [out=-15,in=180] (hmm7);
   			
   			\draw[thick,->,shorten >=1pt] (hmm3) to [out=0,in=165] (stop);
   			\draw[thick,->,shorten >=1pt] (hmm6) to [out=0,in=180] (stop);
   			\draw[thick,->,shorten >=1pt] (hmm10) to [out=0,in=195] (stop);
    		...
    		\hline
    	\end{tabular}
    	\caption{Niezoptymalizowany automat dla słów: \textit{kot}, \textit{kos}, \textit{kasa}. Dla uproszczenia automatu fonemy są reprezentowane pojedynczymi stanami. \textit{jabłko}}
	...
	\begin{figure}[H]
		...
		\begin{tabular}{|c|}
			...
			\node [hmm, above of=hmm3] (hmm4) {$s$};
			
			\node [hmm, below of=hmm2] (hmm5) {$a$};
			\node [hmm, right of=hmm5] (hmm6) {$s$};
			\node [hmm, right of=hmm6] (hmm7) {$a$};
			
			\node [hmm, left = 2 cm of hmm1] (start) {$start$};
			\node [hmm, right = 4 cm of hmm3] (stop) {$stop$};
			
			\coordinate [below of=hmm7] (P1);
			\coordinate [below of=hmm5] (P2);
			
			\draw[thick,->,shorten >=1pt] (hmm1) to [out=0,in=180] (hmm2);
			\draw[thick,->,shorten >=1pt] (hmm2) to [out=0,in=180] (hmm3);
			
			\draw[thick,->,shorten >=1pt] (hmm2) to [out=15,in=196] (hmm4);
			
			\draw[thick,->,shorten >=1pt] (hmm1) to [out=-15,in=165] (hmm5);
			\draw[thick,->,shorten >=1pt] (hmm5) to [out=0,in=180] (hmm6);
			\draw[thick,->,shorten >=1pt] (hmm6) to [out=0,in=180] (hmm7);
			...
			\draw[thick,->,shorten >=1pt] (hmm3) to [out=0,in=180] (stop);
			\draw[thick,->,shorten >=1pt] (hmm4) to [out=0,in=165] (stop);
			\draw[thick,->,shorten >=1pt] (hmm7) to [out=0,in=195] (stop);
