    ...
    \subsection{Ukryte modele Markova - definicja}
	   ...
	   \subsubsection{Algorytmy Viterbiego}
		   ...
		   \begin{itemize}
			   	...
			   	\item Aby znaleźć prawdopodobieństwo stanu po $k$ krokach można wyznaczyć korzystając z równania \ref{equation:viterbi_node}.
		   \end{itemize}
		   ...
		   \begin{figure}[H]
		   	...
		   	\node [hmm, below of=hmm2] (hmm3) {$s_2$};
		   	\node [hmm, below of=hmm3] (hmm4) {$s_2$};
		   	\node [hmm, below of=hmm4] (hmm5) {$s_2$};
		   	
		   	\node [hmm, right = 3.5 cm of hmm3] (hmm6) {$s_2$};
		   	
		   	\draw [->] (hmm1) [out=0, in=140]  to (hmm6);
		   	\draw [->] (hmm2) [out=0, in=160]  to (hmm6);
		   	\draw [->] (hmm3) [out=0, in=180]  to (hmm6);
		   	\draw [->] (hmm4) [out=0, in=200]  to (hmm6);
		   	\draw [->] (hmm5) [out=0, in=220]  to (hmm6);
		   	\end{scope}
